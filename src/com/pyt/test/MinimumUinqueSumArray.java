 ...
 * @author suresh
 */
public class MinimumUinqueSumArray {
	...
	public static void main(String[] args) {
		...
		try (Scanner sc = new Scanner(System.in)) {
			...
			System.out.println("Enter number of values to values to process");
			int n = sc.nextInt();
			if (n >= 1 && n <= 2000) {
				...
				if (isValidInputs) {
					...
					System.out.println("The minimum unique sum of given vlaues :" + minimumUniqueSum);
				}
			} else {
